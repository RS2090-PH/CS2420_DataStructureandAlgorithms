...
def equals(lyst1, lyst2):
    """ Returns True if they are both empty, or their lengths
    are the same and their first items are equal and the rest
    of their items are equal """
    if isEmpty(lyst1) is True and isEmpty(lyst2) is True:
        return True
    if isEmpty(lyst1) is True or isEmpty(lyst2) is True:
        return False
    if first(lyst1) == first(lyst2):
...
def main():
    ...
    lyst1 = THE_EMPTY_LIST
    lyst2 = THE_EMPTY_LIST
    lyst3 = THE_EMPTY_LIST
    lyst4 = THE_EMPTY_LIST
    for j in range(10):
        lyst1 = cons(j, lyst1)
    for k in range(10):
        lyst2 = cons(k, lyst2)
    lyst3 = cons(9, cons(8, cons(7, cons(6, cons(5, cons(4, cons(3, cons(2, cons(1, cons(9, lyst3))))))))))
    lyst4 = cons(9, cons(8, cons(7, cons(6, cons(5, cons(4, cons(3, cons(2, cons(1, cons(9, cons(10, lyst4)))))))))))
    ...
    print(equals(lyst1, lyst2))
    print(equals(lyst2, lyst3))
    print(equals(lyst3, lyst4))

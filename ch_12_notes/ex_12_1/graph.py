...
class LinkedVertex(object):
    ...
    def addEdgeTo(self, toVertex, weight):
        ...
        if edge in self.edgeList:
            raise AttributeError("Edge already present.")
        else:
...
class LinkedDirectedGraph(AbstractCollection):
    ...
    def addVertex(self, label):
        ...
        if label in self.vertices:
            raise AttributeError("Vertex already present.")
        else:
    ...
    def getVertex(self, label):
        if label not in self.vertices:
            raise AttributeError("Vertex not present.")
        else:
    ...
    def addEdge(self, fromLabel, toLabel, weight):
        """Connects the vertices with an edge with the given weight."""  #FIXME: finish this one
